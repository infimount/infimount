...
- Strengthen storage validation with clearer capability summaries; grouped validation results, sanitized fix hints, MCP readiness notes, and copyable summaries are delivered in v0.7.0.
