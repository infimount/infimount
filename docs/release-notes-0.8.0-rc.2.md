# Infimount 0.8.0-rc.2: Trust and Activation Release Candidate

Infimount 0.8.0-rc.2 is the prerelease validation build for the v0.8 trust, recovery, workspace, and MCP activation work.

Compared with rc.1 (which never published), rc.2 additionally carries:
