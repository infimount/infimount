# Infimount 0.8.0-rc.3: Release-Preflight and Recovery-Ordering Candidate

Infimount 0.8.0-rc.3 is the prerelease validation build for the v0.8 release-preflight, recovery-ordering, and updater trust-chain work.
